...
B = 200
results_2 = run_PRT(num_data=2, B=B)
...
ax[0].set_xlabel("Posterior samples", size=12)
ax[0].set_ylabel("Prior samples", size=12)
ax[0].set_title("N=2", size=15)
...
ax[1].set_xlabel("Posterior samples", size=12)
ax[1].set_ylabel("Prior samples", size=12)
...
ax[2].set_xlabel("Posterior samples", size=12)
ax[2].set_ylabel("Prior samples", size=12)
